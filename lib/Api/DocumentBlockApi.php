...
class DocumentBlockApi
{
    ...
    {
        list($response) = $this->listDocumentBlockWithHttpInfo($page, $per_page, $type);
        return $response;
    }
     ...
     */
    public function listDocumentBlockAsync($page = null, $per_page = '25', $type = null)
    {
        return $this->listDocumentBlockAsyncWithHttpInfo($page, $per_page, $type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function listDocumentBlockRequest($page = null, $per_page = '25', $type = null)
    {
